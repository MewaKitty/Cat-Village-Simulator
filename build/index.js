...
document.getElementsByClassName("test")[0].style.setProperty("--num", "0");
setTimeout(() => document.getElementsByClassName("test")[0].style.setProperty("--num", "100"), 1000);
setTimeout(() => document.getElementsByClassName("test")[0].style.setProperty("--num", "50"), 2000);
var raid = false;
var foodStock = [];
var maxFoodStock = 1000;
var tick = () => {
