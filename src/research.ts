...
import { createCatElement, randomCat, abilities, createNewRole } from "./cats.ts"
            ...
            for (const recipeId of craftable) {
                ...
                for (const craftAmount of craftAmounts) {
                    ...
                    craftButton.addEventListener("click", () => {
                        ...
                        woodSpan.style.setProperty("--num", game.inventory[recipe.result] + "")
                        woodSpan.setAttribute("aria-label", game.inventory[recipe.result] + "")
                    })
                }
            }
        })
